 ...
 *
 * Short description for HttpNotFoundException class.
 *
 * Longer description for HttpNotFoundException class, if any.
 *
 * PHP version 5.6
 *
...
class HttpNotFoundException extends HttpException
{
    public function response() {
        return new \purity\core\Response(new View('errors/404'), 404);
    }
}